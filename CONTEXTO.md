...
**Pasta de trabalho:** `14-projetos/20260807-cria-imagio` — é lá que a sessão de desenvolvimento abre
(`jd-claude <agente> cria-imagio`). Quando existe pasta de trabalho, o trabalho é
